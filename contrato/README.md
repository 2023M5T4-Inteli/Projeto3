...
&emsp;&emsp; O diagrama de implementação uml, possibilita o processo descrito no diagrama de sequência uml uma que ao representar os diferentes hardwares que fazem parte do sistema, é possível associá-los com os membros participantes do diagrama de sequência.  <br>
&emsp;&emsp; Primeiramente vale mencionar o computador do usuário, que abriga tanto o frontend, representado pela plataforma web do usuário no diagrama de sequência, que possibilita que ele entre em contato com  o servidor. E a carteira do usuário, representada pela mesma no diagrama de sequência, a qual assim como no de sequência fará o depósito diretamente para o smart contract, localizado no bloco de hardware Teste-net no diagrama de implantação.  <br>
&emsp;&emsp;  Em paralelo a isso temos o computador do Gestor, que como elemento importante para o processo de adição de membro, mencionado do diagrama de sequência, tempos o frontend do gestor. Que possibilita, através dele, a aprovação da solicitação de um novo membro no contrato, além de receber o feedback do aporte. Sendo assim seu computador uma parte essencial do processo apresentado no diagrama de sequência<br>
&emsp;&emsp; Também, vale mencionar o servidor e a rede test-net, blocos de hardware apresentados no diagrama de implantação. começando pelo servidor, que não o relacionar com diagrama de sequência, podemos colocar  ele como quem fornece a plataformas web do gestor e do usuário, mencionadas anteriormente, além de ser o responsável, através do backend nele contido, por realizar o processo de comunicação entre os comandos do front e o smart contract, podendo chamar as funções mencionadas no diagrama de sequência como adicionarUsuarios() e visualizarCarteiras(). Por fim o bloco da test net, formado por vários computadores participantes da rede, que farão o trabalho de manter o smart contract, o qual no diagrama de sequência é responsável por executar as funções mencionadas anteriormente e receber o fundos enviados pela carteira do usuário.  <br>
&emsp;&emsp; Portanto, podemos concluir que os diagramas de sequência e implantação estão ligados. Sendo os hardwares retratados no diagrama de implantação peças essenciais para entender a lógica dos participantes retratados no diagrama de sequência, e como a comunicação entre eles realmente ocorreria em uma situação real, considerando todos os hardwares que participariam para o funcionamento real da solução. Sendo possivel ter uma maior noção de como o diagrama de sequência funcionaria em uma situação real. <br>
